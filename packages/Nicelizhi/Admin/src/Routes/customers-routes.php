...
use Nicelizhi\Admin\Http\Controllers\Customers\AddressController;
use Nicelizhi\Admin\Http\Controllers\Customers\CustomerController;
use Nicelizhi\Admin\Http\Controllers\Customers\CustomerGroupController;
use Nicelizhi\Admin\Http\Controllers\Customers\ReviewController;

/**
 * Customers routes.
 */
Route::group(['middleware' => ['admin'], 'prefix' => config('admin.admin_url') . '/customers'], function () {
